...
(function($) {
    ...
    $.fn.Tabledit = function(options) {
        ...
        var defaults = {
            ...
            inputClass: 'am-form-field am-radius am-input-sm',
            toolbarClass: 'btn-toolbar',
            groupClass: 'am-btn-group',
            dangerClass: 'danger',
            ...
            buttons: {
                edit: {
                    class: 'am-btn am-btn-xs am-btn-default',
                    html: '<span class="am-icon-pencil"></span>',
                    action: 'edit'
                },
                delete: {
                    class: 'am-btn am-btn-xs am-btn-default',
                    html: '<span class="am-icon-trash"></span>',
                    action: 'delete'
                },
                save: {
                ...
                restore: {
                    class: 'am-btn am-btn-xs am-btn-warning',
                    html: 'Restore',
                    action: 'restore'
                },
                confirm: {
